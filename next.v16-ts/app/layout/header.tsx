...
export default function Header({}) {
  ...
  return(
    ...
    <nav className="navbar navbar-expand-lg bg-dark">
      ...
      {/* OFFCANVAS MENU */}
      <div className="offcanvas offcanvas-end bg-secondary" data-bs-scroll="true" id="offcanvasMenu" aria-labelledby="offcanvasWithBothOptionsLabel">
      ...
      <div className="offcanvas-body">
        ...
        <ul className="nav flex-column">
          <li className="nav-item" data-bs-dismiss="offcanvas">
            <Link className="nav-link text-white" aria-current="page" href={"/aboutus"}>&nbsp;About Us</Link>
          </li>
            ...
            { 
              username !== '' ? (
                <ul className="navbar-nav mr-auto">              
                  ...
                  <ul className="nav flex-column">
                    <li className="nav-item" data-bs-dismiss="offcanvas">
                      <Link className="nav-link text-white" href={"/#"} data-bs-toggle="modal" data-bs-target="#staticLogin">&nbsp;Login</Link>
                    </li>
                    <li className="nav-item"><hr/></li>
                    <li className="nav-item" data-bs-dismiss="offcanvas">
                      <Link className="nav-link text-white" href={"/#"} data-bs-toggle="modal" data-bs-target="#staticRegister">&nbsp;Register</Link>
                    </li>            
                  </ul>
              )    
            }
